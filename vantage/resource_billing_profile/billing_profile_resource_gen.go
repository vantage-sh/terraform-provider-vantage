...
package resource_billing_profile
...
func BillingProfileResourceSchema(ctx context.Context) schema.Schema {
	return schema.Schema{
		Attributes: map[string]schema.Attribute{
			"banking_information_attributes": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					...
					"secure_data": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Encrypted banking details",
					},
				...
				MarkdownDescription: "Banking details (MSP accounts only)",
			},
			"billing_information_attributes": schema.SingleNestedAttribute{
				...
				MarkdownDescription: "Billing address and contact information",
			},
			"business_information_attributes": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"metadata": schema.SingleNestedAttribute{
						...
						MarkdownDescription: "Business metadata including custom fields",
					},
					"token": schema.StringAttribute{
						Optional: true,
						Computed: true,
				...
				MarkdownDescription: "Business information and custom fields",
			},
			...
			"invoice_adjustment_attributes": schema.SingleNestedAttribute{
				Attributes: map[string]schema.Attribute{
					"adjustment_items": schema.ListNestedAttribute{
						NestedObject: schema.NestedAttributeObject{
							Attributes: map[string]schema.Attribute{
								"adjustment_type": schema.StringAttribute{
									...
									Default: stringdefault.StaticString("charge"),
								},
								"amount": schema.Float64Attribute{
									Required:            true,
									Description:         "Amount or percentage value",
									MarkdownDescription: "Amount or percentage value",
								},
								...
								"name": schema.StringAttribute{
									...
									MarkdownDescription: "Name of the adjustment",
								},
							},
						...
						MarkdownDescription: "Array of adjustment items",
					},
					"token": schema.StringAttribute{
						Optional: true,
						Computed: true,
				...
				MarkdownDescription: "Invoice adjustments (taxes, fees, etc.)",
			},
			...
			"token": schema.StringAttribute{
				Computed:            true,
				Description:         "The token of the billing profile",
				MarkdownDescription: "The token of the billing profile",
			},
...
type BillingProfileModel struct {
	BankingInformationAttributes  BankingInformationAttributesValue  `tfsdk:"banking_information_attributes"`
	...
	InvoiceAdjustmentAttributes   InvoiceAdjustmentAttributesValue   `tfsdk:"invoice_adjustment_attributes"`
