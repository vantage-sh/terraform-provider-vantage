...
func (t BudgetsType) ValueFromObject(ctx context.Context, in basetypes.ObjectValue) (basetypes.ObjectValuable, diag.Diagnostics) {
	...
	periodCadenceAttribute, ok := attributes["period_cadence"]

	if !ok {
		diags.AddError(
			"Attribute Missing",
			`period_cadence is missing from object`)

		return nil, diags
	}

	periodCadenceVal, ok := periodCadenceAttribute.(basetypes.ObjectValue)

	if !ok {
		diags.AddError(
			"Attribute Wrong Type",
			fmt.Sprintf(`period_cadence expected to be basetypes.ObjectValue, was: %T`, periodCadenceAttribute))
	}
	...
	return BudgetsValue{
		...
		PeriodCadence:     periodCadenceVal,
		Periods:           periodsVal,
		Token:             tokenVal,
		BudgetsType:       typeVal,
		Unit:              unitVal,
...
type BudgetsValue struct {
	...
	PeriodCadence     basetypes.ObjectValue `tfsdk:"period_cadence"`
...
func (v BudgetsValue) ToTerraformValue(ctx context.Context) (tftypes.Value, error) {
	...
	attrTypes["period_cadence"] = basetypes.ObjectType{
		AttrTypes: PeriodCadenceValue{}.AttributeTypes(ctx),
	}.TerraformType(ctx)
	...
	case attr.ValueStateKnown:
		...
		val, err = v.PeriodCadence.ToTerraformValue(ctx)

		if err != nil {
			return tftypes.NewValue(objectType, tftypes.UnknownValue), err
		}

		vals["period_cadence"] = val
...
func (v BudgetsValue) ToObjectValue(ctx context.Context) (basetypes.ObjectValue, diag.Diagnostics) {
	...
	var periodCadence basetypes.ObjectValue

	if v.PeriodCadence.IsNull() {
		periodCadence = types.ObjectNull(
			PeriodCadenceValue{}.AttributeTypes(ctx),
		)
	}

	if v.PeriodCadence.IsUnknown() {
		periodCadence = types.ObjectUnknown(
			PeriodCadenceValue{}.AttributeTypes(ctx),
		)
	}

	if !v.PeriodCadence.IsNull() && !v.PeriodCadence.IsUnknown() {
		periodCadence = types.ObjectValueMust(
			PeriodCadenceValue{}.AttributeTypes(ctx),
			v.PeriodCadence.Attributes(),
		)
	}
	...
	if diags.HasError() {
		return types.ObjectUnknown(map[string]attr.Type{
			...
			"period_cadence": basetypes.ObjectType{
				AttrTypes: PeriodCadenceValue{}.AttributeTypes(ctx),
			},
...
func (v BudgetsValue) Equal(o attr.Value) bool {
	...
	if !v.PeriodCadence.Equal(other.PeriodCadence) {
		return false
	}
