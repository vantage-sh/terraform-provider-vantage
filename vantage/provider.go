...
func (p *vantageProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewBudgetAlertsDataSource,
		NewScenarioModelsDataSource,
		NewReportForecastsDataSource,
		...
		NewFolderDataSource,
		NewEnrichmentSourcesDataSource,
		NewEnrichmentSourceDataSource,
	}
}
