...
page_title: "vantage_team Resource - workspace"
subcategory: ""
description: |-
...
- `default_dashboard_token` (String) The token of a Dashboard to set as the Team default. Send an empty string to clear.
