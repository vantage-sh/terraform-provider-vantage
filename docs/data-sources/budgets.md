...
- `q` (String) Search budgets by name.
- `workspace_token` (String) The workspace token of the budgets to return.
...
<a id="nestedatt--budgets--period_cadence"></a>
### Nested Schema for `budgets.period_cadence`
...
- `starts_at` (String) The anchor date for budget period intervals. ISO 8601 date (YYYY-MM-DD).
